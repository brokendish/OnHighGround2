  ...
  await page.route('/api/evacuation', route => route.fulfill({
    ...
    body: JSON.stringify(evacuationBody ?? {
      ...
      recommended: {
        ...
        hazard_safe: null,
        hazard_coverage_status: {
          flood: 'NO_HAZARD_RECORD', storm_surge: 'NO_HAZARD_RECORD', tsunami: 'NO_HAZARD_RECORD',
          inland_flood: 'NO_HAZARD_RECORD', landslide: 'NO_HAZARD_RECORD', lowland_poor_drainage: 'NO_HAZARD_RECORD',
        },
