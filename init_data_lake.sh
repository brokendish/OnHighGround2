...
mkdir -p \
  ...
  "${PROJECT_ROOT}/data_lake/raw/tokyo/elevation" \
  "${PROJECT_ROOT}/data_lake/raw/tokyo/river_flood" \
  ...
  "${PROJECT_ROOT}/data_lake/raw/tokyo/road_network" \
  "${PROJECT_ROOT}/data_lake/normalized/tokyo/elevation" \
  "${PROJECT_ROOT}/data_lake/normalized/tokyo/river_flood" \
  ...
  "${PROJECT_ROOT}/data_lake/normalized/tokyo/road_network" \
  "${PROJECT_ROOT}/data_lake/validated/tokyo/elevation" \
  "${PROJECT_ROOT}/data_lake/validated/tokyo/river_flood" \
  ...
  "${PROJECT_ROOT}/data_lake/validated/tokyo/road_network" \
  "${PROJECT_ROOT}/data_lake/tiles/tokyo/river_flood" \
