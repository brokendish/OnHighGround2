...
function setup()
  ...
  return {
    ...
    speeds = Sequence {
      highway = {
        trunk           = walking_speed * OHG_TRUNK_PENALTY,
        trunk_link      = walking_speed * OHG_TRUNK_PENALTY,
        primary         = walking_speed * OHG_PRIMARY_PENALTY,
        primary_link    = walking_speed,
        secondary       = walking_speed * OHG_SECONDARY_FACTOR,
