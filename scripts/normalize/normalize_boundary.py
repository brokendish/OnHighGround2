...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        default="data_lake/normalized/tokyo/boundary/tokyo_boundary.geojson",
...
def main() -> int:
    ...
    feature_collection = {
        ...
        "name": "tokyo_boundary_placeholder",
        "features": [],
    }
    ...
    print(f"Wrote normalized boundary placeholder to {output_path}")
    return 0
